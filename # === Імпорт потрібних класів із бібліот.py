...
questions_list = []
questions_list.append( Question("Скільки буде 2+2?", "4", "8", "0", "9") )
...
questions_list.append( Question("Скільки буде 4+4?", "8", "4", "0", "9") )
questions_list.append( Question("sio take kaktus", "kaktus", "nebo ", "koputer","chasy") )
...
def check_answer():
    ...
    if answers[0].isChecked():                # Перша кнопка — правильна (після shuffle)
        ...
        print("Набрано балів", window.score, "Пройдено запитань", window.total)
